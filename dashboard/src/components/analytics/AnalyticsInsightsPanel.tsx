    ...
    <Panel>
      ...
      <PanelBody className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4">
          ...
          <p className="mt-1 text-xs text-zinc-500">com severidade CRITICAL na fotografia atual</p>
        </div>
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4">
          ...
          <p className="mt-1 text-xs text-zinc-500">hotspots com priority score acima do limiar operacional</p>
        </div>
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4">
          ...
          {data?.insights.topHotspotId ? (
            <Link href={`/hotspots/${data.insights.topHotspotId}`} className="mt-3 inline-flex items-center gap-2 text-sm text-yellow-400 hover:text-yellow-300">
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4">
          ...
          {data?.insights.topMoverId ? (
            <Link href={`/hotspots/${data.insights.topMoverId}`} className="mt-3 inline-flex items-center gap-2 text-sm text-emerald-400 hover:text-emerald-300">
              Abrir hotspot <ArrowUpRight className="h-4 w-4" />
            </Link>
          ) : null}
        </div>
